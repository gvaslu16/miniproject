...
The data flow graph in figure \ref{fig:dfg} presents the data dependencies
...
\begin{figure}[H]
	\centering
	\includegraphics[clip, trim=2cm 7cm 2.2cm 2.5cm, width = \linewidth,angle=90]{cordic_dfg.pdf}
	\caption{DFG for CORDIC}
	\label{fig:dfg}
\end{figure}
